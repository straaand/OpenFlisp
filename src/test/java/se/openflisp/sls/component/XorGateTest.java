...
public class XorGateTest extends GateTest {
	...
	public TruthTable generateTruthTable() {
		...
		table.add(SignalConfiguration.HIGH_FLOATING_LOW, Signal.State.FLOATING);
		table.add(SignalConfiguration.LOW_HIGH_FLOATING, Signal.State.FLOATING);
		table.add(SignalConfiguration.HIGH_FLOATING_LOW, Signal.State.FLOATING);
		table.add(SignalConfiguration.TWO_HIGH, Signal.State.LOW);
		...
		table.add(SignalConfiguration.LOW_LOW_HIGH, Signal.State.HIGH);
		table.add(SignalConfiguration.LOW_HIGH_HIGH, Signal.State.LOW);
		table.add(SignalConfiguration.LOW_HIGH_LOW, Signal.State.HIGH);
		return table;
	}
}
